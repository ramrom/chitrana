...
- Ember.js: Front-end to implement a single page application
- React.js: Front-end to implement a single page application
- d3js: library to actually render each chart
